# -*- coding: utf-8 -*-
"""
Created on Sat Dec 12 18:00:27 2020
...
#%%
    ...
    #Load the file
    stazioni = gpd.read_file('../../dataset/Informal Modeling/data/cycling_points.geojson')
    ...
    for i in stazioni.itertuples():
        ...
        if idx % 10 ==0:
            print('Finished '+ str(idx)+ ' items.') 
    print('finished Iterating Dataset.')

  #%%
    print('Start exporting datasets...')
    exportPath = '../../dataset/Data Integration/data/CyclePoints/'
