...
if __name__ == '__main__':
    ...
    ds_path = '../../dataset/Formal Modeling/data/fuel_pumps.json'
    ...
    with open(ds_path, 'r') as ds_file:
        ...
        for row in dataset:            
            ...
            #generate facility
            facility = Facility(
                type="FUELSTATION - {}".format(row['Name'] if row['Name'] != None else ''),
                price=price,
                contact=contact,
                ranking=1,
                address=address,
    ...
    ds_out_path = '../../dataset/Formal Modeling/data/fuel_pumps_assured.json'
